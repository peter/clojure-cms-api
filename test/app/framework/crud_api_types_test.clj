(ns app.framework.crud-api-types-test
  (:use midje.sweet)
  (:require [app.framework.crud-api-types :refer [coerce-attribute-types]]
            [app.util.date :as d]))
...
(fact "coerce-attribute-types: nullifies blank values in nested attributes"
  (let [attributes {
    ...
    (coerce-attribute-types attributes schema) => expected))
